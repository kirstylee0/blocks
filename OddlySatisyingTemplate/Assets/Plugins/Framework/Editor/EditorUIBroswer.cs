...
public class EditorUIBroswer : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        switch (_tab)
        {
            case 0: StyleBrowser.OnGUI(); break;
            case 1: IconBrowser.OnGUI(); break;

        }
    }


    static class StyleBrowser
    {
    ...
    static class IconBrowser
    {
        ...
        static bool isWide => Screen.width > 550;

        static bool doSearch => !string.IsNullOrWhiteSpace(search) && search != "";
        ...
        static void SaveIcon(string icon_name)
        {
