...
namespace Framework
{
    ...
    public static class StringUtils
    {
        ...
        /// <summary>
        /// Takes an amount of seconds and returns a human readable version of that time period in seconds.
        /// </summary>
        /// <param name="time">The amount of time, in seconds</param>
        /// <returns>The time in a nice SS format</returns>
        public static string GetSecondsString(float time)
        {
            if (time <= 0) return "00";

            DateTime dateTime = new DateTime().AddSeconds(time);

            return dateTime.Second.ToString("D2");
        }
        ...
        /// <summary>
        /// SITTSM EDIT: Takes an amount of seconds and returns a human readable version of that time period in minutes, seconds and Milliseconds.
        /// </summary>
        /// <param name="time">The amount of time, in seconds</param>
        /// <returns>The time in a nice MM:SS:MM format</returns>
        public static string GetTimeStringMilliseconds(float time)
        {
            ...
            return dateTime.ToString("mm:ss:ff");// .Minute.ToString("D2") + ":" + dateTime.Second.ToString("D2") + ":" + dateTime.Millisecond.ToString("D2");
        }
